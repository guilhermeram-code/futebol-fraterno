...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-emerald-50/30 to-white">
      ...
      {promoBannerVisible && (
        <div className="fixed top-16 left-0 right-0 z-40 bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-500 shadow-lg">
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-white font-bold text-sm md:text-base leading-tight">
                  Seu campeonato organizado de graça — vagas limitadas!
                </p>
                <p className="text-emerald-100 text-xs md:text-sm leading-tight hidden sm:block">
                  Estamos selecionando campeonatos para usar o PeladaPro sem custo.
                </p>
              </div>
            </div>
      ...
      <section className={`${promoBannerVisible ? 'pt-36 md:pt-40' : 'pt-24 md:pt-28'} pb-12 px-4 md:pb-16 transition-all duration-300`}>

...
import { ArrowLeft, Users, Shield, ChevronRight } from "lucide-react";
      ...
      <header className="bg-secondary text-secondary-foreground">
        <div className="container py-4">
          <div className="flex items-center gap-4">
            ...
            />
            <div>
              <h1 className="text-xl font-bold text-gold">Times</h1>
              <p className="text-sm text-muted-foreground">Todos os participantes</p>
            </div>
          </div>
        </div>
      </header>
